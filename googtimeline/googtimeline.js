 ...
 * @author Florian Käfert, Ralf Heukäufer 
 * @email ralf.heukaeufer@hf-mixinggroup.com
 * @description
    ...
    return {
                        ...
                        tooltip: {
                            ...
                            items: {
                                ...
                                tooltipIsHTML: {
                                    ...
                                    show: function (e) {
                                        return e.qHyperCubeDef.qMeasures.length == 3 && e.showTooltip;
                                    }
                                }
                            }
                        },
                        ...
                        color: {
                            ...
                            items: {
                                ...
                                colorByRowLabel: {
                                    ...
                                    ref: "colorByRowLabel",
                                    show: function (e) {
                                        return e.qHyperCubeDef.qDimensions.length > 1 && !e.useSingleColor;
                                    },
                                    options: [{
                                            value: true,
                                            translation: "properties.on"
        ...
        paint: function ($element, layout) {
            ...
            function prepareData() {
                ...
                if (dCnt == 3 && layout.thirdDimension) {
                    result.addColumn({
                        type: 'string',
                        id: 'style',
                        role: 'style'
                ...
                function render(data) {
                    ...
                    data.forEach(function (page, pageNo) {
                        ...
                        page[0].qMatrix.forEach(function (row, rowNo) {
                            ...
                            if (readRow) {
                                ...
                                // Null value handling
                                if (layout.handleNullAll && !layout.handleNullPoint && row[dCnt].qText == '-') {
                                    return;
                                };

                                if (layout.handleNullAll && !layout.handleNullPoint && row[dCnt + 1].qText == '-') {
                                    return;
                                };
                                ...
                                //Dim 3 - ColorByDimension
                                if (dCnt == 3 && layout.thirdDimension) {
                                    values.push(row[2].qText);
                                };
                                colorbyvalue.push(row[2].qText);

                                // Mes 3 - Tooltip
                                if (mCnt == 3) {
                                    values.push(row[cellCnt - 1].qText);
                                };
                    ...
                    //function MarcarHoy (div, filas){$('#'+div+' text:contains("Today")').css('font-size','11px').attr('fill','#A6373C').prev().first().attr('height',filas*41+'px').attr('width','1px').attr('y','0')};

                    //Create options-object
                    var options = {
                        avoidOverlappingGridLines: true,
                        backgroundColor: (layout.useBackgroundColor) ? layout.backgroundColor.color : layout.backgroundColor.defaultValue,
                        colors: (layout.thirdDimension) ? colorbyvalue : null,
                    ...
                    //Events - Selections
                    google.visualization.events.addListener(chart, 'select', selectHandler, function () {
                        addMarker(new Date());
                    });
